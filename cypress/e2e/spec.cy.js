describe("Product page", function () {
  ...
  it("visits my site", function () {
    cy.get(".product-card").should("exist").and("have.length.greaterThan", 0)
  })
...
describe("Skapa konto och logga in", () => {
  beforeEach(() => {
    cy.visit("http://localhost:5173/")
  ...
  it("skapar konto och loggar sedan in med samma uppgifter ", () => {
    ...
    cy.contains("Inloggning lyckades!").should("exist")
